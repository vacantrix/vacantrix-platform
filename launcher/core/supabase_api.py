...
# Shared session — один pool на всё приложение, без connectionpool-предупреждений
...
def activate_subscription(access_token: str, tool_id: str, plan_id: str, duration_days: int) -> None:
    ...
    user_r = _session.get(f"{AUTH_URL}/user", headers=_auth_headers(access_token), timeout=10)
